  ...
  return (
    <section className="rounded-xl border border-zinc-700 bg-zinc-900/70 p-4 sm:p-5">
      ...
      <div className="mt-4 flex flex-col gap-3 sm:flex-row">
        <input ref={inputRef} type="file" accept={accept} className="min-w-0 flex-1 rounded border border-zinc-600 bg-black p-2 text-sm file:mr-3 file:rounded file:border-0 file:bg-white file:px-3 file:py-2 file:font-bold file:text-black" />
